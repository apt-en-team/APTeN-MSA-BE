...
public interface VisitorUsageMonthlyRepository extends JpaRepository<VisitorUsageMonthly, Long> {
    ...
    // 단지와 사용 연월 기준 월 집계 페이지를 조회한다.
    Page<VisitorUsageMonthly> findByComplexIdAndUsageYearAndUsageMonth(Long complexId, Integer usageYear, Integer usageMonth, Pageable pageable);
}
