...
public enum ParkingVehicleErrorCode implements ErrorCode {
    ...
    VEHICLE_FEE_MONTHLY_NOT_FOUND(HttpStatus.NOT_FOUND, "PVH_404_11", "산정된 차량 월 과금이 없습니다."),
    ...
    REGULAR_VISITOR_COMPLEX_MISMATCH(HttpStatus.FORBIDDEN, "PVH_403_06", "다른 단지의 고정 방문차량입니다."),
