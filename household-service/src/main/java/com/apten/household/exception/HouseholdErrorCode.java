...
public enum HouseholdErrorCode implements ErrorCode {
    ...
    HOUSEHOLD_HAS_EXPECTED_RESIDENT(HttpStatus.BAD_REQUEST, "HHD_400_05", "등록된 입주민 명부가 있어 삭제할 수 없습니다."),
    ...
    DUPLICATE_MATCH_REQUEST(HttpStatus.CONFLICT, "HHD_409_40", "이미 처리 중인 세대 매칭 요청이 있습니다."),
    ...
    HOUSEHOLD_TYPE_NOT_FOUND(HttpStatus.NOT_FOUND, "HHD_404_30", "평형을 찾을 수 없습니다."),
    BUILDING_LINE_TYPE_NOT_FOUND(HttpStatus.NOT_FOUND, "HHD_404_31", "동 라인 평형을 찾을 수 없습니다."),
    DUPLICATE_HOUSEHOLD_TYPE(HttpStatus.CONFLICT, "HHD_409_30", "이미 존재하는 평형 코드입니다."),
    HOUSEHOLD_TYPE_IN_USE(HttpStatus.BAD_REQUEST, "HHD_400_30", "사용 중인 평형은 삭제할 수 없습니다."),
    BUILDING_LINE_TYPE_OVERLAPPED(HttpStatus.CONFLICT, "HHD_409_31", "이미 등록된 호 라인 범위와 겹칩니다."),
    EXPECTED_RESIDENT_NOT_FOUND(HttpStatus.NOT_FOUND, "HHD_404_40", "입주민 명부를 찾을 수 없습니다."),
    MATCH_EXPECTED_RESIDENT_REQUIRED(HttpStatus.BAD_REQUEST, "HHD_400_41", "입주민 명부를 먼저 등록해야 승인할 수 있습니다."),
    MATCH_REQUEST_NOT_SELECTED(HttpStatus.BAD_REQUEST, "HHD_400_42", "승인할 매칭 요청을 선택해주세요."),
    DUPLICATE_EXPECTED_RESIDENT(HttpStatus.CONFLICT, "HHD_409_41", "이미 등록된 입주민 명부입니다."),
    EXPECTED_RESIDENT_STATUS_INVALID(HttpStatus.BAD_REQUEST, "HHD_400_40", "수정할 수 없는 입주민 명부 상태입니다."),
