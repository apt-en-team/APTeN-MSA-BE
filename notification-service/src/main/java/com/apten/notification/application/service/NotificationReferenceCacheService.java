...
import com.apten.notification.domain.repository.ApartmentComplexCacheRepository;
import com.apten.notification.domain.repository.HouseholdCacheRepository;
import com.apten.notification.domain.repository.HouseholdMemberCacheRepository;
import com.apten.notification.domain.repository.UserCacheRepository;
import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

// notification-service에서 참조 캐시 테이블 upsert를 담당하는 서비스
@Service
@Transactional
