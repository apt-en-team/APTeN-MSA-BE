...
public enum AuthErrorCode implements ErrorCode {
    ...
    ADMIN_PROFILE_NOT_FOUND(HttpStatus.NOT_FOUND, "AUTH_404_02", "관리자 프로필 정보를 찾을 수 없습니다."),
    ...
    INVALID_PARAMETER(HttpStatus.BAD_REQUEST, "AUTH_400_03", "잘못된 요청 파라미터입니다."),
    ...
    PASSWORD_POLICY_INVALID(HttpStatus.BAD_REQUEST, "AUTH_400_04", "비밀번호는 8자 이상이며 영문, 숫자, 특수문자를 포함해야 합니다."),
    SOCIAL_ACCOUNT_NO_PASSWORD(HttpStatus.BAD_REQUEST, "AUTH_400_05", "소셜 로그인 전용 계정은 비밀번호 변경이 불가합니다."),
    RESET_TOKEN_INVALID(HttpStatus.BAD_REQUEST, "AUTH_400_06", "유효하지 않거나 만료된 재설정 토큰입니다."),
    INVALID_ADMIN_ROLE(HttpStatus.BAD_REQUEST, "AUTH_400_07", "유효하지 않은 관리자 권한입니다.");
